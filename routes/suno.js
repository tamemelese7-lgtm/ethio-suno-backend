...
async function masterAudio(audioUrl) {
  ...
  try {
    ...
    await new Promise((resolve, reject) => {
      execFile(ffmpegPath, ['-y','-i',inPath,'-af','highpass=f=22,equalizer=f=100:width_type=h:g=6,equalizer=f=3000:width_type=o:width=1.4:g=3,equalizer=f=10000:width_type=h:g=4,loudnorm=I=-14:TP=-1.5:LRA=11','-b:a','192k',outPath], { timeout: 60000 }, (err) => err ? reject(err) : resolve());
    });
